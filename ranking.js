    ...
    client.on("message", async (message) => {
        ...
        function levelinghelp() {
            const embed = new Discord.MessageEmbed()
                ...
                .setTimestamp()
                .setDescription(`> **HELP:**  \`${prefix}45l456eve9541561lazezaeinghelp\``)
                .setColor(embedcolor)
                .addFields([{
                        name: "`rank [@User]`",
                        value: ">>> *It shows the rank of the user*",
                        inline: true
                    },
                    {
                        name: "`leaderboard`",
                        value: ">>> *Displays the top ten on the leaderboard*",
                        inline: true
                    },
                    {
                        name: "`setxpcounter <@USER> <AMOUNT>`",
                        value: ">>> *change the speed count , x1, x2, x3, ...*",
                        inline: true
                    },

                    {
                        name: "`addpoints <@User> <Amount`",
                        value: ">>> *Add a specified amount of points to the user*",
                        inline: true
                    },
                    {
                        name: "`setpoints <@User> <Amount`",
                        value: ">>> *Adding a specified amount of user points*",
                        inline: true
                    },
                    {
                        name: "`removepoints <@User> <Amount`",
                        value: ">>> *Remove the amount from the specified points user*",
                        inline: true
                    },
                    ...
                    },
                    {
                        ...
                        value: ">>> *User level set*",
                        inline: true
                    },
                    {
                        name: "`removelevel <@User> <Amount`",
                        value: ">>> *User level removal*",
                        inline: true
                    },

                    {
                        name: "`resetranking <@User>`",
                        value: ">>> *reset of the user rank*",
                        inline: true
                    },
                    {
                        name: "`setglobalxpcounter <AMOUNT>`",
                        value: ">>> *set global xp counter*",
                        inline: true
                    },
                    {
                        name: "\u200b",
